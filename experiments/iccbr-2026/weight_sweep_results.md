...
Combined leads in the mid-range (alpha 0.05--0.80), with brief Per-component leads at alpha 0.45--0.50. Section leads at alpha 0.10 (0.404 vs 0.403/0.399). Per-component leads durably above alpha = 0.85 (Per-comp 0.606 vs Combined 0.592) and achieves the overall highest R@10 (0.615 at alpha = 0.90).
