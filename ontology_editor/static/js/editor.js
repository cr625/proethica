...
function initializeEditor() {
    // Load language tools extension before setting autocompletion options
...
function updateVersionsList(versions) {
    ...
    const items = versions.map(version => {
        ...
        return `
            <li class="list-group-item" data-version-id="${version.id}" data-version-number="${version.version_number}">
