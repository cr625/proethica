...
def init_provenance_csrf_exemption(app):
    ...
    app.csrf.exempt(post_review_log)
...
@provenance_bp.route('/api/provenance/case/<int:case_id>/review-log', methods=['POST'])
@auth_optional
...
@provenance_bp.route('/api/provenance/case/<int:case_id>/review-log', methods=['GET'])
@auth_optional
