...
- provision_codes: for a code or regulation, list the provision code(s) cited (e.g. "I.1", "II.2.b"). Leave empty for a non-code resource.
- Emit one resource individual per distinct source used or cited, not one per canon citation.
