...
class LLMService:
    ...
    def _create_mock_llm(self) -> BaseLLM:
        ...
        responses = [
            # Chat responses
            "I understand you're looking at an ethical decision-making scenario. This appears to be related to a military medical triage situation. In such scenarios, medical personnel must make difficult decisions about allocating limited resources to patients based on severity of injuries and likelihood of survival. Would you like me to explain the key ethical principles involved in triage decisions?",
            "Based on the scenario you're viewing, there are several ethical considerations at play. The primary ethical frameworks relevant here are utilitarianism (maximizing overall welfare), deontology (following duties and respecting rights), and virtue ethics (character and intentions). In military medical triage specifically, medical personnel often follow established protocols that balance these considerations. Would you like me to analyze this specific scenario in more detail?",
