...
# Literature grounding for capability extraction prompts.
# These citations inform the theoretical framework section of the DB prompt template
# (extraction_prompt_templates id=7) and the chapter 2 discussion of capabilities.
CAPABILITY_LITERATURE = {
    'Tolmeijer2021': "Essential capabilities taxonomy for ethical reasoning agents",
    'Berreby2017': "Action Model for representing agent capabilities and effects",
    'Anderson2018': "Learning and adaptation capabilities for ethical decision-making",
    'Hallamaa2022': "Domain-specific competencies required for professional ethics",
    'Langley2019': "Explanation and justification capabilities in ethical agents",
    'Wallach2009': "Capabilities extending beyond rule-following to complex moral decision-making",
}
