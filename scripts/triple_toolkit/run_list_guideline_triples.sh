#!/bin/bash
# Run the list_guideline_triples.py script with proper Python path setup
...
PYTHONPATH="$ROOT_DIR:$PYTHONPATH" python3 -m scripts.triple_toolkit.list_guideline_triples "$@"
