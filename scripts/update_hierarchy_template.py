#!/usr/bin/env python3
"""
Update the ontology hierarchy visualization template to match the main application style
...
src_path = 'ontology_editor/templates/hierarchy.html'
...
# Update the title
content = content.replace('<title>Ontology Hierarchy Visualization</title>', 
                         '<title>ProEthica Ontology Hierarchy</title>')
