#!/usr/bin/env python
"""
Utility script to selectively clean up guideline triples while preserving those 
associated with guideline document ID 190.
...
def main():
    print("=" * 70)
    print("Running Selective Guideline Triple Cleanup")
    print("This will preserve only triples from guideline document ID 190")
    print("=" * 70)
    ...
    sql_script_path = os.path.join(script_dir, "sql", "cleanup_selective_guideline_triples.sql")
    ...
    confirmation = input("Do you want to proceed with selective cleanup? (y/n): ")
    ...
    with open(log_filename, 'w') as log_file:
        log_file.write("Selective Guideline Triple Cleanup Log\n")
        log_file.write("=" * 40 + "\n")
    ...
    print("="*40)
    print("You should now have only the 161 guideline triples associated with guideline document ID 190.")
