#!/usr/bin/env python3
"""
Script for adding characters to the "Conflict of Interest" scenario in the 
"Legal Ethics World (New Jersey)" in the AI Ethical Decision-Making Simulator.

This script adds five characters that represent different perspectives in a legal
conflict of interest situation:
1. Michael Reynolds - Partner with conflict of interest
2. Horizon Technologies Inc. - Corporate client
3. Sarah Chen - Individual client with competing interests
4. Jason Martinez - Associate attorney with conflict of interest
5. Eleanor Washington - Managing partner responsible for ethics compliance

Usage:
1. Run the script: python add_conflict_of_interest_characters.py
"""
...
CHARACTERS = [
    # Michael Reynolds (Partner) with Conflict of Interest
    [
        "Michael Reynolds",
    ...
    # Horizon Technologies Inc. (Corporate Client) with no conditions
    [
    ...
    # Sarah Chen (Individual Client) with no conditions
    [
        "Sarah Chen",
        "http://example.org/nj-legal-ethics#IndividualClient",
        "Individual Client",
        None,
        []
    ],
    # Jason Martinez (Associate Attorney) with Conflict of Interest
    [
        "Jason Martinez",
        "http://example.org/nj-legal-ethics#AssociateAttorney",
        "Associate Attorney",
        1,  # Junior level
        [
            [
                "http://example.org/nj-legal-ethics#ConflictOfInterest",
                "Conflict of Interest",
                "Working on cases with competing client interests",
                6
            ]
        ]
    ],
    # Eleanor Washington (Managing Partner) with no conditions
    [
        "Eleanor Washington",
        "http://example.org/nj-legal-ethics#ManagingPartner",
        "Managing Partner",
        4,  # Executive level
        []
    ]
...
def add_characters_to_scenario():
    """Add defined characters to the Conflict of Interest scenario."""
    app = create_app()
