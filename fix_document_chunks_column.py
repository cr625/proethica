#!/usr/bin/env python3
"""
Execute the fix_document_chunks_content_column.sql script to add the missing content column
to the document_chunks table.
"""
...
def main():
    ...
    sql_file = 'fix_document_chunks_content_column.sql'
